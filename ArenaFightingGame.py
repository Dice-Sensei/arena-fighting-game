# Malý projekt:
# - začne se v hodině, dokončit doma
# - Textová hra na hrdiny a jejich souboj v aréně - formát 1:1
# - Programátor definuje hrdiny a ty budou mezi sebou bojovat
...
# - princip fungování:
#     - začne souboj
#     - aréna představí oba soupeře
##     - aréna refreshen oba soupeře (aby neměly vyplýtvaný skilly…)
#     - začne kolo souboje
